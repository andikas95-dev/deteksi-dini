...
import { sidelinks } from '@/helpers/data/sidelink';
import { LogoDeteksiDiniPrimary } from '../assets/icons';
import { LogoDeteksiDiniOnly } from '../assets/icons/logo-deteksidini';
  ...
  return (
    ...
    >
      ...
      <Layout fixed className={navOpened ? 'h-svh' : ''}>
        ...
        <Layout.Header
          sticky
          className="z-50 flex justify-center px-4 py-3 shadow-sm md:px-4"
        >
          <div className={`flex justify-center items-center ${!isCollapsed ? 'gap-2' : ''}`}>
            ...
            {isCollapsed ? <LogoDeteksiDiniOnly className='transition-all' width={30} /> : <LogoDeteksiDiniPrimary className='transition-all' width={150} />}
            {/* <div
